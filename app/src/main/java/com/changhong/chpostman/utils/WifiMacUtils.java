...
public class WifiMacUtils {
    ...
    public static boolean compareMac(String mac1, String mac2) {
        ...
        if (mac1.indexOf(':') == -1 && mac2.indexOf(':') == -1)
    ...
    public static String macShownFormat(@NonNull String mac) {
        if (mac.length() == 12) {
    ...
    public static String macNoColon(@NonNull String mac) {
        if (mac.length() == 12) {
            return mac;
        }
        return mac.replace(String.valueOf(mac.charAt(2)), new String());
    }
}
